        ...
        return (
            <div className="container">
                ...
                <form onSubmit={(event) => this.handleSubmit(event)}>
                    ...
                    <div className="form-group">
                        <label>Pincode</label>
                        <input type="text" className="form-control" id="name" placeholder="Enter Pincode" value={this.state.user.userPincode} onChange={(event) => this.handlePincodeChange(event)} />
                        {
                            (this.state.pincodeError) ?
                                <div className="alert alert-dismissible alert-danger">
                                    <button type="button" className="close" data-dismiss="alert">&times;</button>
                                    <strong>sorry!</strong>Pincode Cannot be empty
                                </div> : null
                        }
                    </div>
